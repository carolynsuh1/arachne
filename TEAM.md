...
| 3. Dynamic graph based on goal | this repo | Read `goal_plans` + SQLite rows. Locally match people and power the Goal Views dashboard. | Change the Goal → Network agent. |
...
- `GET /goals/{goal_id}/graph` — locally matched people for one saved goal
- `GET /network/tracker` — companies, clubs, organizations, and geographic areas
