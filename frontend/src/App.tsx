...
export default function App() {
  ...
  const [page, setPage] = useState<Page>("copilot")
  ...
  function openBrainDump(person: { id: string; name: string }) {
    setBrainDumpPerson(person)
    setPage("brain-dump")
  }
      ...
      <header className="flex flex-wrap items-center gap-4 border-b border-stone-300 px-6 py-4">
        ...
        <nav className="flex flex-wrap gap-2 font-sans text-sm">
          ...
          <button
            ...
            className={`rounded-full px-4 py-1.5 ${page === "copilot" ? "bg-stone-900 text-white" : "text-stone-700"}`}
          >
