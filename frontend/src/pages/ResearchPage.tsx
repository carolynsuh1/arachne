...
export function ResearchPage({target:initialTarget,goal,viewerId,viewerName,onOpenProfiles}:{target?:ResearchTarget;goal?:string;viewerId?:string;viewerName?:string;onOpenProfiles:()=>void}) {
